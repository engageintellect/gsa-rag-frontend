...
function Footer() {
  return (
    <div>
      <footer className="footer p-10 bg-gradient-to-b from-gray-600 to-gray-900 border-t border-gray-900 text-white">
        <nav>
          <div className="">
            <Image src="/ResonantLogic_Logo_White.svg" className="mb-2 drop-shadow" alt="logo" width={200} height={200} />
            <div>Experts in business transformation</div>
          </div>
        </nav>
        <nav>
          <h6 className="footer-title">Solutions</h6> 
          <a className="link link-hover">Artifical Intellegence</a>
          <a className="link link-hover">Cybersecurity</a>
          <a className="link link-hover">Data Science</a>
          <a className="link link-hover">Enterprise Operations</a>
          <a className="link link-hover">Healthcare Technology</a>
        ...
        <nav className="w-full">
          {/* <h6 className="footer-title">Accredidations</h6>  */}
