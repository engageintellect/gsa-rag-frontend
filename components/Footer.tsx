      ...
      <footer className="footer p-10 border-t border-gray-900 bg-base-100">
        <nav>
          <a className="sm:hover:scale-[102%] transition-all duration-300" href="https://resonantlogic.com" target="_blank">
            <Image src="/ResonantLogic_Logo_White.svg" className="drop-shadow" alt="logo" width={200} height={200} style={{ filter: 'invert(100%)' }} />
          </a>
          <div className="">Experts in business transformation.</div>
            
          <a href="https://www.linkedin.com/company/resonantlogic.com/about/" target="_blank">
